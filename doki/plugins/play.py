...
from doki.utils.decorators.language import languageCB
from doki.utils.decorators.play import PlayWrapper
from doki.utils.formatters import formats
from doki.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from doki.utils.inline.playlist import botplaylist_markup
from doki.utils.logger import play_logs
    ...
    if audio_telegram:
        ...
        if await YouTube.exists(url):
            ...
            if (
                ...
                return await mystic.edit_text(
                    "This Bot Can't play Spotify Track & Playlists"
                )
            if "track" in url:
                try:
            ...
            try:
                ...
                await mystic.edit_text(
                    "Theres n Error in the Bot, Please Report it to Support Chat As Soon As Possible."
                )
                return await app.send_message(
                    config.LOG_GROUP_ID,
                    "Please Turn on VC to Stream URL.",
                )
            except Exception as e:
                return await mystic.edit_text(
