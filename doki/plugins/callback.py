...
from doki.utils.formatters import seconds_to_min
from doki.utils.inline import (
    stream_markup,
    stream_markup_timer,
    telegram_markup,
...
async def unban_assistant_(_, CallbackQuery):
    ...
    if not a.can_restrict_members:
        return await CallbackQuery.answer(
            "I ont Have Permissions To Unban Users in This Chats.",
            show_alert=True,
        )
    else:
        try:
            ...
            return await CallbackQuery.answer(
                "Failed To Unban The Ally Acc.",
                show_alert=True,
            )
        return await CallbackQuery.edit_message_text(
            "Ally Acc Unbanned Successfully.\n\nTry Playin Now..."
        )
